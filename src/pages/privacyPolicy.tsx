...
const privacyPolicy: React.FC = () => (
  <div className="mt-2 space-y-4">
    <h3 className="text-2xl font-bold">
      Privacy Policy for Chie
    </h3>

    <div>
      At Chie, accessible from https://www.chie.app, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Chie and how we use it.
    </div>
    ...
    <div>
      ...
      and is valid for visitors to our website with
      regards to the information that they shared and/or collect in Chie.
      ...
      help of the Online Generator of Privacy Policy.
    </div>
    ...
    <div>
      Chie follows a standard procedure of using log files.
    ...
    <div>
      Like any other website, Chie uses &apos;cookies&apos;.
    ...
    <div>
      ...
      for each of the advertising partners of Chie.
    </div>

    <div>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective advertisements and
      links that appear on Chie, which are sent directly to users&apos; browser.
    ...
    <div>
      Note that Chie has no access to or control over these cookies
    ...
    <div>
      Chie&apos;s Privacy Policy does not apply to other advertisers or websites.
    ...
    <div>
      ...
      the categories and specific pieces of personal data that
    ...
    <div>
      Chie does not knowingly collect any Personal Identifiable Information from children
